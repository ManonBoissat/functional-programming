...
object balelec {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(467); 
 ...
 /**
  ...
  val v1 = Volunteer("Marc");System.out.println("""v1  : constraints.balelec.Volunteer = """ + $show(v1 ));$skip(29); 
  val v2 = Volunteer("Jean");System.out.println("""v2  : constraints.balelec.Volunteer = """ + $show(v2 ));$skip(28); 
  val v3 = Volunteer("Dom");System.out.println("""v3  : constraints.balelec.Volunteer = """ + $show(v3 ));$skip(31); 
  val v4 = Volunteer("Fabien");System.out.println("""v4  : constraints.balelec.Volunteer = """ + $show(v4 ));$skip(29); 
  
  val t1 = Task("Bar", 1);System.out.println("""t1  : constraints.balelec.Task = """ + $show(t1 ));$skip(28); 
  val t2 = Task("Scene", 1);System.out.println("""t2  : constraints.balelec.Task = """ + $show(t2 ));$skip(31); 
  val t3 = Task("Lumieres", 1);System.out.println("""t3  : constraints.balelec.Task = """ + $show(t3 ));$skip(26); 
  val t4 = Task("Son", 2);System.out.println("""t4  : constraints.balelec.Task = """ + $show(t4 ));$skip(60); 
  
  val volunteers: List[Volunteer] = List(v1, v2, v3, v4);System.out.println("""volunteers  : List[constraints.balelec.Volunteer] = """ + $show(volunteers ));$skip(43); 
	val tasks: List[Task] = List(t1,t2,t3,t4);System.out.println("""tasks  : List[constraints.balelec.Task] = """ + $show(tasks ));$skip(239); 
	...
	);System.out.println("""availability  : Map[constraints.balelec.Volunteer,List[constraints.balelec.Task]] = """ + $show(availability ));$skip(26); 
	...
	val varsMatrixTV: Map[(Volunteer, Task), PropVar] =
	  ...
	  }).toMap;System.out.println("""varsMatrixTV  : Map[(constraints.balelec.Volunteer, constraints.balelec.Task),cafesat.api.Formulas.PropVar] = """ + $show(varsMatrixTV ))}
}
